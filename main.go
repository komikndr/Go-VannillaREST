...
func (ts *taskServer) createTaskHandler(w http.ResponseWriter, req *http.Request) {
	...
	//Struct used internally to json (de) serialize, from/to JSON
...
func (ts *taskServer) deleteAllTaskHandler(w http.ResponseWriter, req *http.Request) {
...
func main() {
	...
	var port string
	flag.StringVar(&port, "port", "8080", "Port number for the server")

	// Parse the command-line arguments
	flag.Parse()

	fmt.Printf("Starting services on port %s\n", port)
